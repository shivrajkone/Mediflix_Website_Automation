...
public class Mylist_Verify_prod extends login_prod
...
//	    driver.get("https://client-portal.us-east-1.dev.mediflix.com/browse");
		driver.get("https://www.mediflix.com/browse");
	    ...
	    load_page.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[1]/div/main/div[2]/div[1]/div/div[3]/div/div/div[1]/div/div/div/a")));
	    ...
	    topic_name = driver.findElement(By.xpath("/html/body/div[1]/div/main/div[2]/div[1]/div/div[3]/div/div/div[1]/div/div/div/div[2]/div")).getText();
	    ...
	    video_name=driver.findElement(By.xpath("/html/body/div[1]/div/main/div[2]/div[1]/div/div[3]/div/div/div[1]/div/div/div/div[2]/div")).getText();
	    System.out.println("topic for selection_________________"+video_name);
	    ...
	    click_video.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[1]/div/main/div[2]/div[3]/div/div[3]/div/div/div[1]/div/div/div[2]/div/button"))).click();
...
//	    driver.get("https://client-portal.us-east-1.dev.mediflix.com/journey");
		driver.get("https://www.mediflix.com/journey");
...
//	    }
	    ...
	    //click on channel
	    WebDriverWait click_channel_icon= new WebDriverWait(driver, Duration.ofSeconds(30));
	    click_channel_icon.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[1]/div/main/div/div[4]/div/div[3]/div/div/div[3]/div/div/a"))).click();
...
//	 @Test (enabled = false)
	public void unfollow() throws InterruptedException
	{
	    ...
	    //load   
	    WebDriverWait load_topic = new WebDriverWait(driver, Duration.ofSeconds(30));
	    load_topic.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[1]/div/main/div/div[2]/div/div[3]/div/div/div/div/div/div/a")));
	    ...
	    click_follow_channel.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[1]/div/main/div[1]/div[4]/div/button[2]"))).click();
